...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || "MEGALODON~MD~3AFGgQoD#B2fz-7V_iHvpIraU9IizjkbGU1xvQBOMmuraaPrVG_U",  // Your bot's session ID (keep it secure)
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "50940362871",  // Owner's WhatsApp number
    
    OWNER_NAME: process.env.OWNER_NAME || getConfig("MR_DRAGON FILS DE HOMMIE") || "",           // Owner's name
